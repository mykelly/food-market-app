...
/**
 * Created by fishboneLsy on 2015/6/29.
 */
public class MySwipeRefreshLayout extends ViewGroup {
    ...
    private static final int STARTING_PROGRESS_ALPHA = 255;

    private static final int CIRCLE_DIAMETER = 40;
    private static final int CIRCLE_DIAMETER_LARGE = 42;
    ...
    private static final int CIRCLE_BG_LIGHT = 0xFFFFFFFF;
    ...
    public void setSize(int size) {
        ...
        mCircleView.setBackgroundColor(Color.parseColor("#ffffffff"));
    ...
    private void createProgressView() {
        if(true){//(mProgressDrawable!=null){
            mCircleView = new MyCircleImageView(getContext(), getResources().getDrawable(R.drawable.a0001big));
            Log.d("tag" , "the width is =====================" + mCircleView.getWidth());
           // 自定义加载图片
        }
        else{
            mCircleView = new MyCircleImageView(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER/2);
        }
    ...
    public void setmProgressDrawable(Drawable mProgressDrawable) {
